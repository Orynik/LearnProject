...
<!ENTITY % basic.block          "%p;|%lq;|%note;|%dl;|%ul;|%ol;|%pre;|%lines;|%fig;|%image;|%object;|%table;|%simpletable;">
...
<!ENTITY % basic.ph.noxref      "%ph;|%term;|              %q;|%boolean;|%state;|%keyword;">
...
<!ENTITY % topicreftypes 'topic | concept | task | reference | external'>
...
<!ENTITY % rel-atts      'type (%topicreftypes;|other) #IMPLIED
...
<!ATTLIST body            outputclass CDATA #IMPLIED>
...
<!ATTLIST xref            href CDATA #IMPLIED
                          ...
                          type    (fig|figgroup|table|li|fn|section|%topicreftypes;|other) #IMPLIED
                          othertype CDATA #IMPLIED
                          %univ-atts;
                          outputclass CDATA #IMPLIED
>
...
<!ELEMENT linklist       (%title;, (%desc;)?,(%linklist; | %link;)*)>
<!ATTLIST linklist        collection-type (unordered|ordered|choice|tree|family) #IMPLIED
...
<!ATTLIST linkpool        collection-type (unordered|ordered|choice|tree|family) #IMPLIED
                          duplicates (yes|no) #IMPLIED
                          mapkeyref CDATA #IMPLIED
                          %rel-atts;
                          %select-atts;
