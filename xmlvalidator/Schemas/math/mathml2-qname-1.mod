...
<!-- file: mathml2-qname-1.mod
     ...
     Revision: $Id: mathml2-qname-1.mod,v 1.1.2.1 2002/09/03 18:55:30 jdj Exp $ 
...
<!ENTITY % MATHML.pfx "">
<!ENTITY % MATHML.xmlns.attrib "xmlns        CDATA           #FIXED '%MATHML.xmlns;'
      %MATHML.xmlns.extra.attrib;">
<![%NS.prefixed;[
<!ENTITY % XHTML.xmlns.extra.attrib 
     "%MATHML.xmlns.attrib;" >
]]>
<!ENTITY % XHTML.xmlns.extra.attrib "%XLINK.xmlns.attrib;">
